...
class Try_use_apply_api extends API_Controller {
    ...
    public function __construct(){
        ...
        $this->mail_conf = array(
            "config"    => array(
                ...
                'smtp_user' => '1174826734@qq.com',
                'smtp_pass' => 'ykehycuihgmqjbea',
                'smtp_port' => 465,
                'crlf'      => "\r\n",
                'newline'   => "\r\n",
                'smtp_crypto'=> 'ssl',
            ...
            "content"   => "姓名: [name] \r\n 公司：[company] \r\n 职位：[job] \r\n 电子邮件：[email] \r\n 电话：[phone] \r\n 留言内容：\r\n",
            "receiver"  => "1299234033@qq.com,magenjie@feeyo.com",
        );
    }
    ...
    public function input(){
        ...
        foreach (explode(",", $this->mail_conf["receiver"]) as $email) {
            ...
            $this->email->from('1174826734@qq.com', 'ACDM ADMIN');
            $this->email->to($email);
